...
mod tests {
    ...
    fn test_from_axis_angle_cpp_cases() {
        ...
        assert_eq!(
            Quat::from_axis_angle(Vec3 { x: 1.0, y: 0.0, z: 0.0 }, 0.0),
            QuatApprox(Quat { x: 0.0, y: 0.0, z: 0.0, w: 1.0 })
        );

        assert_eq!(
            Quat::from_axis_angle(Vec3 { x: 0.0, y: 1.0, z: 0.0 }, 0.0),
            QuatApprox(Quat { x: 0.0, y: 0.0, z: 0.0, w: 1.0 })
        );

        assert_eq!(
            Quat::from_axis_angle(Vec3 { x: 0.0, y: 0.0, z: 1.0 }, 0.0),
            QuatApprox(Quat { x: 0.0, y: 0.0, z: 0.0, w: 1.0 })
        );

        assert_eq!(
            Quat::from_axis_angle(Vec3 { x: 1.0, y: 0.0, z: 0.0 }, PI_2),
            QuatApprox(Quat { x: 0.7071, y: 0.0, z: 0.0, w: 0.7071 })
        );

        assert_eq!(
            Quat::from_axis_angle(Vec3 { x: 0.0, y: 1.0, z: 0.0 }, PI),
            QuatApprox(Quat { x: 0.0, y: 1.0, z: 0.0, w: 0.0 })
        );

        assert_eq!(
            Quat::from_axis_angle(Vec3 { x: 0.0, y: 0.0, z: 1.0 }, PI_4),
    ...
    fn test_from_look_rotation_cpp_cases() {
        ...
        assert_eq!(Quat::from_look_rotation(forward, up), QuatApprox(Quat { x: 0.0, y: 0.0, z: 0.0, w: 1.0 }));
        ...
        assert_eq!(q_arbitrary * forward, Vec3Approx(Vec3 { x: 0.57735027, y: 0.57735027, z: 0.57735027 }));
    }
    ...
    fn test_quat_multiplication_cpp_cases() {
        ...
        assert_eq!(
            identity * Quat::from_axis_angle(Vec3 { x: 1.0, y: 0.0, z: 0.0 }, PI_4),
            QuatApprox(Quat::from_axis_angle(Vec3 { x: 1.0, y: 0.0, z: 0.0 }, PI_4))
        );

        assert_eq!(
            Quat::from_axis_angle(Vec3 { x: 0.0, y: 1.0, z: 0.0 }, PI_4) * identity,
        ...
        assert_eq!((q_x_45 * q_y_45) * q_z_45, QuatApprox(q_x_45 * (q_y_45 * q_z_45)));
    }
    ...
    fn test_quat_vec_multiplication_cpp_cases() {
        ...
        // Rotation around y-axis by 90 degrees
        assert_eq!(
            Quat::from_axis_angle(Vec3 { x: 0.0, y: 1.0, z: 0.0 }, PI_2) * Vec3 { x: 1.0, y: 0.0, z: 0.0 },
            Vec3Approx(Vec3 { x: 0.0, y: 0.0, z: -1.0 })
        );

        // Rotation around x-axis by 180 degrees
        assert_eq!(
            Quat::from_axis_angle(Vec3 { x: 1.0, y: 0.0, z: 0.0 }, PI) * Vec3 { x: 0.0, y: 1.0, z: 0.0 },
            Vec3Approx(Vec3 { x: 0.0, y: -1.0, z: 0.0 })
        );

        // Identity rotation
        assert_eq!(Quat::identity() * Vec3 { x: 1.0, y: 2.0, z: 3.0 }, Vec3Approx(Vec3 { x: 1.0, y: 2.0, z: 3.0 }));

        // Rotation around x-axis by 90 degrees
        assert_eq!(
            Quat::from_axis_angle(Vec3 { x: 1.0, y: 0.0, z: 0.0 }, PI_2) * Vec3 { x: 0.0, y: 0.0, z: 1.0 },
            Vec3Approx(Vec3 { x: 0.0, y: -1.0, z: 0.0 })
        );

        // Rotation around z-axis by 90 degrees
        assert_eq!(
            Quat::from_axis_angle(Vec3 { x: 0.0, y: 0.0, z: 1.0 }, PI_2) * Vec3 { x: 1.0, y: 1.0, z: 0.0 },
            Vec3Approx(Vec3 { x: -1.0, y: 1.0, z: 0.0 })
        );

        // Rotation around z-axis by 90 degrees (another vector)
        assert_eq!(
            Quat::from_axis_angle(Vec3 { x: 0.0, y: 0.0, z: 1.0 }, PI_2) * Vec3 { x: 1.0, y: 0.0, z: 0.0 },
            Vec3Approx(Vec3 { x: 0.0, y: 1.0, z: 0.0 })
        );

        // Rotation around z-axis by 45 degrees
        assert_eq!(
            Quat::from_axis_angle(Vec3 { x: 0.0, y: 0.0, z: 1.0 }, PI_4) * Vec3 { x: 1.0, y: 0.0, z: 0.0 },
        ...
        assert_eq!(
            Quat::from_axis_angle(Vec3 { x: 1.0, y: 0.0, z: 0.0 }, two_pi_3) * Vec3 { x: 0.0, y: 1.0, z: 0.0 },
            Vec3Approx(Vec3 { x: 0.0, y: -0.5, z: 0.8660254037844386 })
        );

        // Rotation around y-axis by 360 degrees (full circle)
        assert_eq!(
            Quat::from_axis_angle(Vec3 { x: 0.0, y: 1.0, z: 0.0 }, 2.0 * PI) * Vec3 { x: 0.0, y: 0.0, z: 1.0 },
            Vec3Approx(Vec3 { x: 0.0, y: 0.0, z: 1.0 })
        );
        ...
        assert_eq!(
            Quat::from_axis_angle(normalized_vec, PI) * Vec3 { x: 1.0, y: 1.0, z: 1.0 },
